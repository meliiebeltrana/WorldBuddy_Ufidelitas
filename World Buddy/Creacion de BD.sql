...
/* No se insertan usuarios por ahora */


/* Insertar 5 favoritos
   Nota: esto funciona cuando ya existan usuarios.
   Si todavía no van a usar login, déjalo comentado.

INSERT INTO usuario (nombre_usuario, correo, contrasena) VALUES
('Juan', 'juan@gmail.com', '1234'),
('María', 'maria@gmail.com', '1234'),
